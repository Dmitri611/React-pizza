      ...
      <div className={styles.basket__container}>
        <div className={styles.basket__content}>
          <div className={styles.basket__top}>
            <div className={styles["basket__top-left"]}>
              <svg
                className={styles["basket__top-svg"]}
                width="31"
                height="31"
                viewBox="0 0 31 31"
                fill="none"
          ...
          <div className={styles.basket__middle}>{/* баскед кард */}</div>
          <div className={styles.basket__bottom}>
            <input
              className={styles["basket__bottom-promo"]}
              type="text"
              placeholder="Промокод"
            />
            <div className={styles["basket__bottom-total"]}>
              <span>
                Всего пицц:{" "}
                <span className={styles["basket__bottom-span"]}>3 шт.</span>
              </span>
              <span>
                Сумма заказа:{" "}
                <span
                  className={classNames(
                    styles["basket__bottom-span"],
                    styles["basket__bottom-span--orange"]
                  )}
                >
                  45 р.
                </span>
            ...
            <div className={styles["basket__bottom-btns"]}>
              <Button className="button--size-m" text="Вернуться назад" />
              <Button className="button--size-m" text="Оплатить сейчас" />
            </div>
          </div>
        </div>
      </div>
